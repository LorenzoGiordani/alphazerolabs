...
| `liq_imbalance` | Sbilanciamento delle liquidazioni (long vs short). Spike = potenziale cascata/squeeze. | [[liq-cascade-reversal-v1]] [[lux-0.1-beta]] [[lux-confluence-rr2-v1]] [[lux-flow-confluence-v1]] [[tsmom-liq-v1]] |
...
| `tsmom` | Time-series momentum: segno del rendimento su lookback. Base delle strategie trend-following. | [[commodities-cot-trend-v1]] [[commodities-trend-v1]] [[crypto-trend-flow-v1]] [[lux-0.1-beta]] [[lux-confluence-rr2-v1]] [[lux-flow-confluence-v1]] [[tsmom-aggressive-v1]] [[tsmom-atr-v1]] [[tsmom-conservative-v1]] [[tsmom-liq-v1]] [[tsmom-v1]] |
...
| `xsection_momentum` | **TODO: definire** (segnale nuovo, non in glossario) | [[xsmom-v1]] |
